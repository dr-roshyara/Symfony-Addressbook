 ...
 */
class getAddressbookRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\AddressbookRepository' shared autowired service.
     *
     * @return \App\Repository\AddressbookRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'AddressbookRepository.php';

        return $container->privates['App\\Repository\\AddressbookRepository'] = new \App\Repository\AddressbookRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
